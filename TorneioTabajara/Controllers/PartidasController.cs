...
namespace TorneioTabajara.Controllers
{
    public class PartidasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Time1Id,Time2Id,DataHora")] Partida partida)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Time1Id,Time2Id,DataHora")] Partida partida)
        {
            if (ModelState.IsValid)
            {
